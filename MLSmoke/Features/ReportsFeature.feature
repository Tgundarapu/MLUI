...
Scenario: Running Pre-built reports for Credit Score of Vehicle Loan
	...
	When User ran Pre-built reports for Credit score
	And User opened credit card reports window
...
Scenario: Running Pre-built reports for Approved Loans
	...
	And User opened reports window
...
Scenario: Custom Report Test Amount Approved 
	...
	And User opened Amount Approved custom report
...
Scenario: Running Pre-built reports for Vehicle App in PDF format
	Given User login to application
	And User navigated to Reports page
	And User selected Credit Score Reports in PDF format for Vehicle Loan 
	When User ran Pre-built reports
