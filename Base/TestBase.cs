...
namespace MLAutoFramework.Base
{
    public class TestBase: ExtentReportBase //UnitTestBase
    {
        ...
        public IWebDriver StartTestExecution(String Browser)
        {
            try
            {
        ...
        public ExtentTest CreateExtentObjectParallel(String Browser)
        {
        ...
        public void CreateExtentObjectSequential(String Browser, String scenario)
        {
            try
            {
